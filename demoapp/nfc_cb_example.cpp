...
NfcHandler::NfcHandler() {
  ...
  this->callbacks.onTagArrival = [](nfc_tag_info_t *tag_info) {
    global_handler_instance->on_tag_arrival(tag_info);
  };

  this->callbacks.onTagDeparture = []() {
    global_handler_instance->on_tag_departure();
  };
